##Twoim zadaniem jest stworzenie fragmentu programu, który wyświetla menu
##z opcjami do wyboru, a następnie zależnie od dokonanego wyboru wykona
##pewne czynności.
...
##
##- w każdym pozostałym przypadku wyświetli instrukcję czekając
##na naciśnięcie ENTER:
