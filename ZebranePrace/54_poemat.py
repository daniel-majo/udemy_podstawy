##1. Zadeklaruj zmienną poem (a przy okazji przeczytaj wiersz i zwróć uwagę
##na jego znaczenie):
##
##    poem = 
##
##2. Do zmiennej lines zapisz wynik rozbicia napisu poem ze względu na znak
##enter czyli "\n".
##
##3. Napisz pętlę for wyświetlającą liniję pierwszą,
## dziewiątą, drugą, dziesiątą, trzecią, jedenastą itp.
## Pisząc pętlę for pamiętaj o tym że tak na prawdę mówimy  o linijkach
## 0,8,1,9,2,10...
##
...
poem = '''1.Runą i w łunach spłoną pożarnych 
    ...
    U stóp tam legną w prochu i pyle! '''
