...
3. To nieco dłuższe zadanie:
    ...
    - twoim celem będzie losowanie liczb losowych tak długo, aż znowu wylosujesz liczbę number1.
...
import random
'''for i in range(10):
    print (i,'liczba - ',random.randint(1,100))'''
'''counter=1
number1=random.randint(1,100)
number2=random.randint(1,100)
print ('Pierwsza próba wylosowania liczb',number1,' i ', number2)
while number1!=number2:
    counter+=1
    print (counter,' próba')
    number1=random.randint(1,100)
    number2=random.randint(1,100)
    print ('Liczba 1-',number1,' : ','Liczba 2-',number2)'''
countries = [
        'Uruguay',
        'Russia',
        'Saudi Arabia',
