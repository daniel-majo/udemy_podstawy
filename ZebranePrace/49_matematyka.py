...
- Każdorazowo wyświetl:
    ...
    - ilość punktów przyznaną danemu krajowi. Da się to obliczyć, bo znamy procentową ilość punktów przyznanych
    danemu krajowi oraz sumaryczną ilość punktów. Rzutując wynik na int, otrzymasz go w postaci liczby całkowitej
...
j=0
i=0
print ('Wartość minimalna: ',min(percent))
print ('Wartość maksymalna: ',max(percent))
print ('--------------------------------------------------------- 1')
